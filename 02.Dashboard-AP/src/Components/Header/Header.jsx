            ...
            <div className="container relative left-0 z-50 flex w-full">
              <div className="relative flex items-center w-full lg:w-64 h-full">
                ...
                <input
                  type="text"
                  placeholder="جستجو"
                  className="block w-full py-2 pr-10 bg-gray-100 leading-normal rounded-2xl focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 ring-opacity-90"
                />
              </div>
            </div>
